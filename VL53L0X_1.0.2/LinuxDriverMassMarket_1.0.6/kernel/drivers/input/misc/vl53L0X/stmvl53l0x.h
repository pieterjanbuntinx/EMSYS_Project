...
#define STMVL53L0X_DRV_NAME	"stmvl53l0"
#define STMVL53L0X_SLAVE_ADDR	(0x52>>1)

#define DRIVER_VERSION		"1.0.5"
#define I2C_M_WR			0x00
/* #define INT_POLLING_DELAY	20 */

/* if don't want to have output from vl53l0x_dbgmsg, comment out #DEBUG macro */
#define DEBUG
...
#define VL53L0X_VDD_MIN      2600000
#define VL53L0X_VDD_MAX      3000000
...
struct stmvl53l0x_data {
	...
	VL53L0X_DevData_t Data;	/* !<embed ST VL53L0 Dev data as
								"dev_data" */
	uint8_t   I2cDevAddr;	/*!< i2c device address user specific field
							*/
	uint8_t   comms_type;	/*!< Type of comms : VL53L0X_COMMS_I2C
							or VL53L0X_COMMS_SPI */
